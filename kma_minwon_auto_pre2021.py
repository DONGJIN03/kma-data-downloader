# -*- coding: utf-8 -*-
"""
기상청 전자민원 - 기상특보(해상) [2020년 이전용]
먼바다는 옛 구역명(~21.07.29 체계) 사용, 기간 1년 그대로
* 2019년 이전은 동해남부/서해남부 먼바다에 4.30 개편이 걸리므로 별도 상의 필요
==============================================================
사전 준비:
...
ZONE_GROUPS = {
    ...
    # ---- 먼바다: 2019.5.1~2021.7.29 체계의 옛 구역명 (2020년은 연중 유효) ----
