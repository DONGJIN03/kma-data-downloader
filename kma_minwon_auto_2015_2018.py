# -*- coding: utf-8 -*-
"""
기상청 전자민원 - 기상특보(해상) [2015~2018년용]
* 14.12.10 개편 이후 ~ 19.04.30 개편 이전 시기 (개편 안 걸침, 1년 통짜)
* 동해남부/서해남부 먼바다 = 통짜 옛명(~'19.04.30), 나머지 먼바다는 ~'21.07.29 명
* 남해서부 먼바다 = 서쪽/동쪽(14.12.10 분할 이후명), 이 시기 유효
* 앞바다는 개편 무관이라 pre2021과 동일. 파일명 꼬리표 없음(1년 통짜)
==============================================================
사전 준비:
...
# ==================== 설정 ====================
MODE = "run"                     # "dump" / "dry" / "run"  (dry 통과 후 run)
YEARS = [2017]                   # 1년치씩 진행 (2015~2018을 한 해씩)
DELAY_SEC = 4                    # 신청 간 대기
LOG_FILE = "신청로그.csv"
...
ZONE_GROUPS = {
    ...
    # ---- 먼바다: 2015~2018 유효 옛명 (동해남부·서해남부는 ~'19.04.30 통짜) ----
